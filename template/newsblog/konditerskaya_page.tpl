...
<section class="video">
    ...
    <div class="swiper kond-swiper">
        ...
        <div class="swiper-button-prev kond-btn--prev"><i class="icon-arrow-left"></i></div>
        <div class="swiper-button-next kond-btn--next"><i class="icon-arrow-right"></i></div>
    </div>
    <?php } ?>
    <script>
        $(document).ready(function(){
        var swiper = new Swiper(".kond-swiper", {
            loop: true,
            navigation: {
                nextEl: ".kond-btn--next",
                prevEl: ".kond-btn--prev",
            },
        });
    ...
    <div class="wrapper">
        ...
        <div class="head d-flex justify-between">
            <div class="head-title uppercase">
                <div class="subtitle mar-none">Кондитерская</div>
