<div id="cart" class="btn-group btn-block">
  <button type="button" data-toggle="dropdown" onclick="location.href='<?php echo $checkout; ?>'" class="btn-cart pointer no--style" data-loading-text="<?php echo $text_loading; ?>">
