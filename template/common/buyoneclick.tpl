<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h3 id="boc_order_title" class="modal-title text-center"><?php echo $buyoneclick_title; ?></h3>
		</div>
		<div class="modal-body">
			<form id="boc_form" action="" role="form">
				<fieldset>
					...
					<div class="clearfix"></div>
					<div class="col-pd-15 row">
						<div style="display:none">
							<input id="boc_product_id" type="text" name="boc_product_id">
						</div>
						<?php if ($buyoneclick_field1_status) { ?>
							<div class="col-sm-6 col-xs-12 <?php if ($buyoneclick_field1_required) { echo ' has-warning';} ?>">
						...
						<?php if ($buyoneclick_field2_status) { ?>
							<div class="col-sm-6 col-xs-12 <?php if ($buyoneclick_field2_required) { echo ' has-warning';} ?>">
					...
					<div class="col-pd-15"></div>
					<div class="clearfix col-pd-15"><hr></div>
					<div class="col-pd-15 text-center">
						<button type="submit" id="boc_submit" class="btn-primary radius red_shadow" onClick="clickAnalyticsSend(); return true;"><?php echo $buyoneclick_button_order; ?></button>
					</div>
				</fieldset>
			</form>
		</div>
