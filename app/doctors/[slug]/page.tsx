        ...
        <Container>
          <Card>
            <CardContent className="p-6 md:p-8">
              ...
              <p className="mt-4 text-sm leading-7 text-muted-foreground">
                На сайте Персона врач {doctor.name} связан с услугами и контентом клиники. Такая перелинковка помогает пользователю быстрее перейти к нужной услуге, а поисковой системе — лучше понять структуру медицинского портала.
              </p>
