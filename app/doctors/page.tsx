...
export const metadata = buildMetadata({
  title: "Врачи клиники в Ставрополе — специалисты Персона",
  description:
    "Врачи медицинского центра Персона в Ставрополе: гинеколог, терапевт, кардиолог, гастроэнтеролог и другие специалисты. Фото, стаж, направления работы, запись на приём.",
