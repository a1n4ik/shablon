...
export const metadata = buildMetadata({
  title: "Статьи клиники — блог о здоровье, диагностике и профилактике | МедПрайм",
  description:
    "Блог медицинского центра МедПрайм: статьи о профилактике, диагностике, кардиологии, УЗИ, анализах и полезных сценариях обращения к врачу.",
