...
export const metadata = buildMetadata({
  title: "FAQ — частые вопросы о приёме, анализах и записи | Персона",
  description:
    "Ответы на частые вопросы о записи в клинику, подготовке, анализах, парковке и режиме работы медицинского центра Персона в Ставрополе.",
  canonicalPath: "/faq",
});
