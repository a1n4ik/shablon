...
export const metadata = buildMetadata({
  title: "Контакты клиники в Краснодаре — адрес, телефон, карта | МедПрайм",
  description:
    "Контакты медицинского центра МедПрайм в Краснодаре: адрес, телефон, режим работы, карта, парковка и форма записи на приём.",
