...
export const metadata = buildMetadata({
  title: "О клинике — лицензии, оборудование, специалисты | МедПрайм",
  description:
    "История, миссия, преимущества, лицензии и специалисты частного медицинского центра МедПрайм в Краснодаре.",
  canonicalPath: "/about",
});
