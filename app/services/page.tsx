...
export const metadata = buildMetadata({
  title: "Услуги клиники — консультации врачей, УЗИ, анализы, чек-апы | МедПрайм",
  description:
    "Каталог услуг медицинского центра в Краснодаре: гинекология, терапия, гастроэнтерология, кардиология, эндокринология, УЗИ, анализы, чек-апы.",
