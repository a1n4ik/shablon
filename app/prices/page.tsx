...
export const metadata = buildMetadata({
  title: "Цены на услуги клиники в Краснодаре | МедПрайм",
  description:
    "Прайс-лист медицинского центра МедПрайм в Краснодаре: консультации врачей, УЗИ, анализы и чек-апы. Удобный поиск по ценам и категориям услуг.",
